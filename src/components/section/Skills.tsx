    ...
    <>
      ...
      <section id="skills" className="bg-[#6E6E6E30] w-full backdrop-blur-md py-10 ">
        <div className="px-3 md:px-14 flex flex-col md:flex-row items-start justify-center gap-5">
          ...
          <div className="bg-[#303030] w-full md:w-1/2 grid grid-cols-3  lg:grid-cols-4 gap-2 p-2 md:p-4 rounded-2xl border border-white/40">
          ...
          <div className="bg-[#303030] w-full md:w-1/2 grid grid-cols-1 gap-6 py-6 px-2 rounded-2xl text-white border border-[#746d6d1a]">
            {SkillList.map((group, groupIdx) => (
              <ul key={groupIdx} className="list-disc list-inside border-2 border-white/30 p-2 gap-3 " >
